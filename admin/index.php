    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark bg-dark" role="navigation" style="margin-bottom: 0">
            <div class="p-3 mb-2 bg-dark text-white">
                ...
                <strong><a class="navbar-brand" href="index.php">Admin Teratai</a> </strong>
...
<a href="index.php?halaman=logout" class="btn btn-danger square-btn-adjust fa fa-sign-out"> Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=produk"><i class="fa fa-th-large"></i> Produk</a></li>
                    <li><a href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart"></i> Pembelian</a></li>
                    <li><a href="index.php?halaman=laporan_pembelian"><i class="fa fa-file-text-o"></i> Laporan</a></li>
